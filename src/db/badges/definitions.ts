...
export const BADGES: BadgeDef[] = [
	...
	},
	{
		key: "on-a-roll",
		name: "On a Roll",
		description: "Stayed active for many weeks in a row.",
		category: "consistency",
		kind: "medal",
		tiers: tiers("on-a-roll", [4, 12, 26]),
		image: image("on-a-roll"),
	},
	{
		key: "regular",
		name: "Regular",
		description: "Kept contributing across many months.",
		category: "consistency",
		kind: "medal",
		tiers: tiers("regular", [3, 6, 12]),
		image: image("regular"),
	},
	{
		key: "evergreen",
		name: "Evergreen",
		description: "A lyric you submitted stayed the top version for months.",
		category: "acclaim",
		kind: "medal",
		image: image("evergreen"),
	},
	{
		key: "councils-choice",
		name: "Council's Choice",
		description: "A lyric you submitted was sealed by the Better Lyrics Council.",
		category: "acclaim",
		kind: "medal",
		image: image("councils-choice"),
	},
	{
		key: "anniversary",
		name: "Anniversary",
		description: "Contributed to Better Lyrics across the years.",
		category: "consistency",
		kind: "medal",
		tiers: tiers("anniversary", [1, 2, 3]),
		image: image("anniversary"),
	},
	{
		key: "translator",
		name: "Translator",
		description: "Submitted lyrics with translations or transliterations.",
		category: "coverage",
		kind: "medal",
		image: image("translator"),
	},
	{
		key: "early-adopter",
		name: "Early Adopter",
